...
class FileBapController extends Controller
{
	/**
	...
	public function actionCreate($id,$name)
	{
		...
		if(isset($_POST['FileBap']))
		{
			$model->attributes=$_POST['FileBap'];
	...
	{
		$dataProvider=new CActiveDataProvider('FileBap');
	...
	{
		$model=new FileBap('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FileBap']))
			$model->attributes=$_GET['FileBap'];
	 ...
	 * @return FileBap the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FileBap::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FileBap $model the model to be validated
	 */
