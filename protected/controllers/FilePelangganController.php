...
class FilePelangganController extends Controller
{
	/**
	...
	{
		$model=new FilePelanggan;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FilePelanggan']))
		{
			$model->attributes=$_POST['FilePelanggan'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePelanggan');
	...
	{
		$model=new FilePelanggan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePelanggan']))
			$model->attributes=$_GET['FilePelanggan'];
	 ...
	 * @return FilePelanggan the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePelanggan::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePelanggan $model the model to be validated
	 */
