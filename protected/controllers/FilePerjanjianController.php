...
class FilePerjanjianController extends Controller
{
	/**
	...
	{
		$model=new FilePerjanjian;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FilePerjanjian']))
		{
			$model->attributes=$_POST['FilePerjanjian'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePerjanjian');
	...
	{
		$model=new FilePerjanjian('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePerjanjian']))
			$model->attributes=$_GET['FilePerjanjian'];
	 ...
	 * @return FilePerjanjian the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePerjanjian::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePerjanjian $model the model to be validated
	 */
