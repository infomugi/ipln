...
class FileJawabanController extends Controller
{
	/**
	...
	{
		$model=new FileJawaban;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FileJawaban']))
		{
			$model->attributes=$_POST['FileJawaban'];
	...
	{
		$dataProvider=new CActiveDataProvider('FileJawaban');
	...
	{
		$model=new FileJawaban('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FileJawaban']))
			$model->attributes=$_GET['FileJawaban'];
	 ...
	 * @return FileJawaban the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FileJawaban::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FileJawaban $model the model to be validated
	 */
