...
class FilePerintahKerjaController extends Controller
{
	/**
	...
	{
		$model=new FilePerintahKerja;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FilePerintahKerja']))
		{
			$model->attributes=$_POST['FilePerintahKerja'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePerintahKerja');
	...
	{
		$model=new FilePerintahKerja('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePerintahKerja']))
			$model->attributes=$_GET['FilePerintahKerja'];
	 ...
	 * @return FilePerintahKerja the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePerintahKerja::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePerintahKerja $model the model to be validated
	 */
