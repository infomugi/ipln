...
class FilePernyataanController extends Controller
{
	...
	{
		$model=new FilePernyataan;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FilePernyataan']))
		{
			$model->attributes=$_POST['FilePernyataan'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePernyataan');
	...
	{
		$model=new FilePernyataan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePernyataan']))
			$model->attributes=$_GET['FilePernyataan'];
	 ...
	 * @return FilePernyataan the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePernyataan::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePernyataan $model the model to be validated
	 */
