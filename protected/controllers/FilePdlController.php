...
class FilePdlController extends Controller
{
	/**
	...
	public function actionCreate($id,$name)
	{
		...
		if(isset($_POST['FilePdl']))
		{
			$model->attributes=$_POST['FilePdl'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePdl');
	...
	{
		$model=new FilePdl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePdl']))
			$model->attributes=$_GET['FilePdl'];
	 ...
	 * @return FilePdl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePdl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePdl $model the model to be validated
	 */
