...
class FileKuitansiController extends Controller
{
	/**
	...
	{
		$model=new FileKuitansi;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FileKuitansi']))
		{
			$model->attributes=$_POST['FileKuitansi'];
	...
	{
		$dataProvider=new CActiveDataProvider('FileKuitansi');
	...
	{
		$model=new FileKuitansi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FileKuitansi']))
			$model->attributes=$_GET['FileKuitansi'];
	 ...
	 * @return FileKuitansi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FileKuitansi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FileKuitansi $model the model to be validated
	 */
