...
class FilePermohonanController extends Controller
{
	/**
	...
	{
		$model=new FilePermohonan;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FilePermohonan']))
		{
			$model->attributes=$_POST['FilePermohonan'];
	...
	{
		$dataProvider=new CActiveDataProvider('FilePermohonan');
	...
	{
		$model=new FilePermohonan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FilePermohonan']))
			$model->attributes=$_GET['FilePermohonan'];
	 ...
	 * @return FilePermohonan the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FilePermohonan::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FilePermohonan $model the model to be validated
	 */
