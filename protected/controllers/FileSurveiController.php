...
class FileSurveiController extends Controller
{
	/**
	...
	{
		$model=new FileSurvei;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FileSurvei']))
		{
			$model->attributes=$_POST['FileSurvei'];
	...
	{
		$dataProvider=new CActiveDataProvider('FileSurvei');
	...
	{
		$model=new FileSurvei('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FileSurvei']))
			$model->attributes=$_GET['FileSurvei'];
	 ...
	 * @return FileSurvei the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FileSurvei::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FileSurvei $model the model to be validated
	 */
