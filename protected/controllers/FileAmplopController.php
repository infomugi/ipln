...
class FileAmplopController extends Controller
{
	/**
	...
	{
		$model=new FileAmplop;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FileAmplop']))
		{
			$model->attributes=$_POST['FileAmplop'];
	...
	{
		$dataProvider=new CActiveDataProvider('FileAmplop');
	...
	{
		$model=new FileAmplop('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FileAmplop']))
			$model->attributes=$_GET['FileAmplop'];
	 ...
	 * @return FileAmplop the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FileAmplop::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FileAmplop $model the model to be validated
	 */
