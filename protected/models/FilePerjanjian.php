...
/**
 * This is the model class for table "file_permohonan".
 *
 * The followings are the available columns in table 'file_permohonan':
 * @property integer $id
 ...
 */
class FilePerjanjian extends CActiveRecord
{
	/**
