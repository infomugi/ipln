...
/**
 * This is the model class for table "file_bap".
 *
 * The followings are the available columns in table 'file_bap':
 * @property integer $id
 ...
 */
class FileLain extends CActiveRecord
{
	/**
	 ...
	 * @return FileBap the static model class
	 */
