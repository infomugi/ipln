			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<?php echo $form->textField($model,'nomor_urut',array('class'=>'form-control','value'=>$model->nomor_urut,'readOnly'=>true)); ?>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<?php echo $form->textField($model,'kode_map',array('class'=>'form-control','value'=>$model->kode_rak.'-'.$model->nomor_urut,'readOnly'=>true)); ?>
					</div>
