					...
					array('update', 'id'=>$model->id_ail,
						...
						<div class="btn-group pull-right">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<?php echo CHtml::link('Kondisi Amplop', 
										array('fileamplop/create', 'id'=>$model->id_ail,'name'=>"amplop",
											), array('title'=>'Upload Kondisi Amplop'));
											?>
										</li>
										<li>
											<?php echo CHtml::link('Kondisi Ail', 
												array('fileail/create', 'id'=>$model->id_ail,'name'=>"ail",
													), array('title'=>'Upload Kondisi Ail'));
													?>
												</li>
												<li>
																																								...
																																								'attributes'=>array(
																																									...
																																									<div class="row">
																																										<div class="col-md-12">
																																											...
																																											<h3><i class="fa fa-file-text"></i> File Amplop: <?php echo $model->kode_map; ?></h3>

																																											<?php 
																																											$dataProvider=new CActiveDataProvider('FileAmplop',array('criteria'=>array('condition'=>'status=1 AND ail_id='.$model->id_ail)));
																																												...
																																												'columns'=>array(
																																													...
																																													array(
																																														...
																																														'buttons'=>array(
																																															'view'=>
																																															array(
																																																'url'=>'Yii::app()->createUrl("FileAmplop/view", array("id"=>$data->id))',
																																																'options'=>array(
																																																	'ajax'=>array(
																																																		'type'=>'POST',
